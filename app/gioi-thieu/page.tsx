  ...
  return (
    <div className="article-page">
      ...
      <main className="article-main static-page">
        ...
        <p>
          <strong>peek</strong> (đọc là “pích”) — <em>Liếc phát biết</em> — là trang tổng hợp
        ...
        <ul>
          <li>
            ...
            uy tín (The Verge, TechCrunch, Engadget, Ars Technica…), kênh YouTube và tài khoản X
        ...
        <p>
          ...
          24/7. Trang không đăng bài quảng cáo trá hình, không thu phí người đọc.
        </p>
      </main>
    </div>
  );
